...
ActiveRecord::Schema.define(version: 2019_10_31_170606) do
  ...
  create_table "roles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["client", "resource_type", "resource_id"], name: "index_roles_on_client_and_resource_type_and_resource_id"
    t.index ["resource_type", "resource_id"], name: "index_roles_on_resource_type_and_resource_id"
    t.index ["trainer", "resource_type", "resource_id"], name: "index_roles_on_trainer_and_resource_type_and_resource_id"
  end
